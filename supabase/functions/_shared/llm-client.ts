...
- IMPORTANT: When a message contains BOTH a task assignment (부탁, 요청, 해줘, 해주세요, 전달, 진행, 작업, 리서치, 보고, 준비) AND a deadline date (~까지, ~일까지, ~전까지), you MUST create BOTH a **create_todo** (for the task) AND a **create_event** (for the deadline). The todo captures the work item with assignees. The event captures the deadline on the calendar. Always generate both actions in the actions array.
