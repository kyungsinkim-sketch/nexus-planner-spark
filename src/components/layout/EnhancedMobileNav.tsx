            ...
            <Sheet open={open} onOpenChange={setOpen}>
              ...
              <SheetContent side="right" className="w-80 p-0 flex flex-col">
                ...
                <div className="p-4 border-b">
                  <p className="text-xs font-medium text-muted-foreground mb-2">근무 상태</p>
                ...
                <nav className="p-4 space-y-1 flex-1 overflow-y-auto">
                  <p className="text-xs font-medium text-muted-foreground mb-2 px-4">메뉴</p>
                  {navItems.map((item) => {
                ...
                <div className="border-t p-4 space-y-2">
                  ...
                  >
                    <div className="flex items-center gap-3">
                      ...
                      <span className="text-sm text-foreground">{language === 'ko' ? '한국어' : 'English'}</span>
                    </div>
                    <div className="relative inline-flex h-6 w-11 items-center rounded-full bg-muted border border-border">
                      <div
                        className={cn(
