...
export function WidgetGrid({ context, projectKeyColor }: WidgetGridProps) {
  ...
  const isBarlessWidget = (widgetType: string) => widgetType === 'worldClock' || widgetType === 'weather' || widgetType === 'todayWeather' || widgetType === 'todayDate' || widgetType === 'activityChart' || widgetType === 'progressChart' || widgetType === 'health' || widgetType === 'budget' || widgetType === 'inspiration';
